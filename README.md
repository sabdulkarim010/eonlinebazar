...
PostgreSQL repository integration tests (99 tests, real Neon) run separately — Jest cannot load the generated `.mts` Prisma client:

```bash
npm test                  # 16 suites, 166 tests — MongoDB in-memory
npm run test:repositories # 7 files, 99 tests — Neon PostgreSQL
```
