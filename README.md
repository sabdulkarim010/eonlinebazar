...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-335%2F335-brightgreen" alt="335/335 Tests Passing">
...
The repository ships with **100% passing automated coverage: 335 / 335 tests** across **51 Jest suites**. Suites use an in-memory MongoDB (`mongodb-memory-server`) and Supertest — no live Atlas, Resend, or Cloudinary calls are required.

PostgreSQL repository integration tests (241 tests, real Neon) run separately:

```bash
npm test                  # 51 suites, 335 tests — MongoDB in-memory
