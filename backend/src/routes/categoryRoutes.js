...
router.patch('/admin/reorder', verifyAdmin, checkPermission('manage_inventory', 'manage_catalog'), ctrl.adminReorder);
router.patch('/admin/:id', verifyAdmin, checkPermission('manage_inventory', 'manage_catalog'),
  ctrl.uploadCategoryImage, ctrl.adminUpdateCategory);
router.put('/admin/:id', verifyAdmin, checkPermission('manage_inventory', 'manage_catalog'),
  ctrl.uploadCategoryImage, ctrl.adminUpdateCategory);
router.patch('/admin/:id/banner', verifyAdmin, checkPermission('manage_inventory', 'manage_catalog'),
  ctrl.uploadBannerImage, ctrl.adminUploadBanner);
router.delete('/admin/:id', verifyAdmin, checkPermission('manage_inventory', 'manage_catalog'), ctrl.adminDeleteCategory);
