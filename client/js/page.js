/**
 * Generic dynamic CMS page renderer for /page/:slug, /pages/:slug, /:slug, and /page.html?slug=.
 * Fetches published content from /api/store/pages/:slug and renders HTML (or Markdown-derived HTML).
 */
(function () {
    const SLUG_BY_PATH = {
    ...
    function renderInfoPage(page) {
        ...
        if (body) {
            ...
            // Inject as live HTML so style="font-size…; color…" applies as CSS.
