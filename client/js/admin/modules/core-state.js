...
window.ADMIN_PAGE_META = {
    ...
    'view-shipping-payments': { title: 'Shipping & Payments',  subtitle: 'Configure shipping thresholds, SMS, courier, WhatsApp, and payment methods.' },
    'view-loyalty-program':   { title: 'Loyalty Program',      subtitle: 'Configure VIP tiers, cashback, points, and refund rules.' },
    'view-store-config':      { title: 'Store Configuration',  subtitle: 'Catalog pagination, flash sale engine, footer, and CMS pages.' },
...
window.pageContentEditMode = false;
window.pageContentEditSnapshot = null;
