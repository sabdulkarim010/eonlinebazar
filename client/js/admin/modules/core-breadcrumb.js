...
const BREADCRUMB_MAP = {
    ...
    'view-manage-products': { group: 'Product & Stock Operations', label: 'Inventory Management' },
    'view-add-product': { group: 'Product & Stock Operations', label: 'Add Product' },
    'manage-category': { group: 'Product & Stock Operations', label: 'Categories' },
    'manage-brands': { group: 'Product & Stock Operations', label: 'Brands' },
    'manage-attributes': { group: 'Product & Stock Operations', label: 'Attributes' },
    'view-suppliers': { group: 'Product & Stock Operations', label: 'Suppliers' },
    'view-warehouses': { group: 'Product & Stock Operations', label: 'Warehouses' },
    'view-purchase-orders': { group: 'Product & Stock Operations', label: 'Purchase Orders' },
