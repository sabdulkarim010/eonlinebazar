...
function buildCreatePayload(shipping = {}, items = []) {
  ...
  return {
    ...
    saveAddressToProfile: shipping.saveAddressToProfile === true,
    saveAddressAsDefault: shipping.saveAddressAsDefault === true,
    addressLabel: String(shipping.addressLabel || shipping.label || 'Home').trim(),
